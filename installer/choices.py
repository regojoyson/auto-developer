...
# Environment variables required per issue tracker. The pipeline always uses
# REST credentials server-side — agent-level MCP access is no longer a
# supported mode (phase scopes deny MCP for all pipeline phases).
ISSUE_TRACKER_ENV = {
    "jira": [
